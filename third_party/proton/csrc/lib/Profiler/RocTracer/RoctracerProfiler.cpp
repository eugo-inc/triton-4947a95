// @EUGO_CHANGE: @begin - no AMD support
...
//       return nullptr;
//     return hip::getKernelNameRefByPtr(launchParams->func,
//     launchParams->stream);
//   }
//   case HIP_API_ID_hipExtModuleLaunchKernel:
...
//   case HIP_API_ID_hipModuleLaunchCooperativeKernel:
//     return
//     hip::getKernelNameRef(data->args.hipModuleLaunchCooperativeKernel.f);
//   case HIP_API_ID_hipModuleLaunchCooperativeKernelMultiDevice: {
//     const hipFunctionLaunchParams *launchParams =
//         data->args.hipModuleLaunchCooperativeKernelMultiDevice.launchParamsList;
//     if (launchParams == nullptr ||
//         data->args.hipModuleLaunchCooperativeKernelMultiDevice.numDevices ==
//         0)
//       return nullptr;
...
//   static void activityCallback(const char *begin, const char *end, void
//   *arg);
//
//   ThreadSafeMap<uint64_t, bool, std::unordered_map<uint64_t, bool>>
//       corrIdToIsHipGraph;
...
//       graphExecToGraph;
//
//   ThreadSafeMap<hipGraph_t, uint32_t, std::unordered_map<hipGraph_t,
//   uint32_t>>
//       graphToNumInstances;
//
...
//       case HIP_API_ID_hipModuleLaunchCooperativeKernel: {
//         hipStream_t Stream =
//         data->args.hipModuleLaunchCooperativeKernel.stream; if
//         (pImpl->streamToCapture.contain(Stream))
//           pImpl->streamToCaptureCount[Stream]++;
//         break;
//       }
//       case HIP_API_ID_hipGraphInstantiateWithFlags: {
...
//       // correlationId
//       processActivity(correlation.corrIdToExternId,
//       correlation.externIdToState,
//                       pImpl->corrIdToIsHipGraph, dataPhases, externId,
//                       record);
//     } else {
...
//   // stops. Use a subsequent flush when the record has completed being
//   written
//   // to resume the flush.
...
//
// } // namespace proton
// @EUGO_CHANGE: @end - no AMD support
